...
//
//  Created by Занков Владимир Владимирович on 24.01.2025.
//
...
class FeedUIIntegrationTests: XCTestCase {
    ...
    func test_feedImageViewRetryButton_isVisibleOnImageURLLoadError() {
        ...
        loader.completeImageLoadingWithError(at: 1)
        XCTAssertEqual(view0?.isShowingRetryButton, false, "Expected no retry action state change for first view once second image loading completes with error")
    ...
    func test_feedImageViewRetryButton_isVisibleOnInvalidImageData() {
        ...
        let view0 = sut.simulateFeedImageViewVisible(at: 0)
        XCTAssertEqual(view0?.isShowingRetryButton, false, "Expected no retry action while loading image")
        
        let invalidImageData = Data("invalid image data".utf8)
        loader.completeImageLoading(with: invalidImageData, at: 0)
        XCTAssertEqual(view0?.isShowingRetryButton, true, "Expected retry action once image loading completes with invalid image data")
    }
    ...
    func test_loadImageDataCompletion_dispatchesFromBackgroundQueueToMainThread() {
        let (sut, loader) = makeSUT()
